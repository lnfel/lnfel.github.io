...
<section id="contact" class="w-screen h-screen shrink-0 flex px-4 py-6 pt-[9rem] md:p-20">
    ...
    <div class="section-content px-6 space-y-4">
        ...
        <div class="grid md:grid-cols-2 gap-2 py-4">
            <ul class="contact-container font-zenless-copy text-2xl space-y-4">
                <Contact name="github" text="github.com/lnfel" href="https://github.com/lnfel">
                    <svg slot="icon" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="w-10 h-10">
                        <title>GitHub</title>
                        <circle class="hidden group-hover:block" cx="12" cy="12" r="11" fill="white"/>
