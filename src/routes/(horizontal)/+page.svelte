                ...
                <ul class="contact-container font-zenless-copy text-sm md:text-2xl space-y-4">
                    <Contact name="github" text="github.com/lnfel" href="https://github.com/lnfel">
                        <svg slot="icon" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 md:w-10 md:h-10">
                            <title>GitHub</title>
                            <circle class="hidden dark:group-hover:block fill-black dark:fill-white" cx="12.5" cy="12.5" r="11"/>
...
<style>
    ...
    :root {
        --github-fill: #181717;
        --gmail-fill: #ea4435af;
        --discord-fill: #5865f2c1;
        --dark-github-fill: #181717;
        --dark-gmail-fill: #EA4335;
        --dark-discord-fill: #5865F2;
    }
    ...
    :global(.contact.gmail > div svg path),
    :global(.contact.gmail > div svg path),
    :global(.contact.gmail > div svg path),
    :global(.contact.gmail > div svg path) {
        fill: var(--gmail-fill);
    ...
    :global(.contact.discord > div svg path),
    :global(.contact.discord > div svg path),
    :global(.contact.discord > div svg path),
    :global(.contact.discord > div svg path) {
